...
# **** Load Files  **** 
# *********************
using  Plots, LaTeXStrings, FixedEffectModels, GeoStats, GeoIO, CSV, DataFrames, Statistics, LinearAlgebra, MAT, Random, StatsBase, NLopt
...
# computing ω and ε 
ωⱼ, ε = get_ω_and_ε(Vlwⱼ,Hₘⱼ,Hᵣᵢ,τᵢⱼ); κ = ν/ε; # setting commuting decay to reduced-form estimate

# ***********************************************************************
# *** Calibration of exogenous fundamentals (solving the equilibrium) ***
# ***********************************************************************
